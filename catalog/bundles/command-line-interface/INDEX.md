...
# lumastack/luma-catalog/command-line-interface 0.6.0
...
- `policy/output-patterns` (policy) — What a command prints when it runs — a decision tree for which kind of message this is, the three slots every message fills, and a catalog of the patterns commands reach for.

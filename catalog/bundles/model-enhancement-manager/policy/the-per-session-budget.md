...
description: An enhancement loads in every session of its model, including the ones where the behaviour never appears. What that costs, and what has to come out before something goes in.
matches:

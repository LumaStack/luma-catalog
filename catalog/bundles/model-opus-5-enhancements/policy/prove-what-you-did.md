...
**Contrastive example.** *"I've updated all three files"* straight after
editing three files is a memory wearing the clothes of a report. *"`grep -c
oldname` returns 0 in all three"* is a check. Both cost one line.
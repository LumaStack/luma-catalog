...
# lumastack/luma-catalog/tutorial-workflow-maker 0.13.0
...
- `type_definitions/tutorial_quiz/DEFINITION` (type_definition)
- `type_definitions/tutorial_step/DEFINITION` (type_definition)

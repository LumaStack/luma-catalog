...
# lumastack/luma-catalog/bundle-manager 0.16.0
...
- `policy/what-a-bundle-may-carry` (policy) — Somebody else's writing in a bundle — what adoption does to their licence, the five routes, and the one that is the default. Present the choice; never make it silently.
  - matches: topic:putting somebody else's writing, code or data into a bundle, topic:deciding whether to vendor an external document or link to it

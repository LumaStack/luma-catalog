...
description: 'The proposal is paired-review. The bundle is named for its traversal, a sweep, and the thing it actually protects is the pairing — the reader''s own read is the product. The cost is specific: sweep carries the completeness contract that keeps sweeps and audits apart, and paired-review removes the word doing that work at exactly the moment the distinction is under pressure. Neither candidate does both of the name''s jobs, and paired-sweep is accurate, slightly awkward, and still needs a glossary. What would settle it is which word people reach for when they are not reading the bundle, and nobody has looked.'
...
*Related:* [[work-items/CATA-0012-a-slice-could-cover-less-than-a-file]] — if a sweep can cover a
...
- Born from the idea it replaces: [`review-sweeps-could-be-named-for-the-pairing`](../../ideas/review-sweeps-could-be-named-for-the-pairing.md)
